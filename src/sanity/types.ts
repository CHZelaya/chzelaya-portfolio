...
// Query: *[_type == "Project"]{    title,    coverImage,    summary,    year,    slug,    status,    workInProgress,    scribbleNote,    githubLink,    liveLink,    technologies[]-> {        name,        category,        icon     },}
...
// Query: *[_type == "Project" && slug.current == $slug][0]{    title,    coverImage,    year,    summary,    status,     workInProgress,    scribbleNote,    caseStudyBody {        problem,        constraints,        approach,        execution,        outcome,        reflection,    },    caseStudyImages {        images[] {            caption,            alt,            imageType,            asset,            hotspot,            crop        }    },    technologies[]-> {        name,        category,        icon     },    githubLink1,    githubLink2,    liveLink,    estimatedReadingTime,}
